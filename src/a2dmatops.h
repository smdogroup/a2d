...
public:
  Mat3x3FromThreeVec3( Vec3&x, Vec3& y, Vec3&z, Mat3x3& C ){
    C.A[0] = x.x[0];
    C.A[3] = x.x[1];
    C.A[6] = x.x[2];
...
public:
  Mat3x3FromVec3( Vec3&x, Mat3x3& C ){
    C.A[0] = x.x[0];
    C.A[3] = x.x[1];
    C.A[6] = x.x[2];
...
public:
  Symm3x3SymmMultTraceScale( Scalar& scale, Symm3x3& S, Symm3x3& T, Scalar& alpha ){
