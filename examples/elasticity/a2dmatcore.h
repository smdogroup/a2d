...
namespace A2D {
  ...
  // C = A^{T} * B
  template<int M, int P, int N, class AMatType, class BMatType, class CMatType>
  void MatTransMatMultCore( const AMatType& A, const BMatType& B, const CMatType& C ){
    for ( int i = 0; i < M; i++ ){
      for ( int j = 0; j < P; j++ ){
        C(i, j) = 0.0;
        for ( int k = 0; k < N; k++ ){
  ...
  // C = A * B^{T}
  template<int M, int P, int N, class AMatType, class BMatType, class CMatType>
  void MatMatTransMultCore( const AMatType& A, const BMatType& B, const CMatType& C ){
    for ( int i = 0; i < M; i++ ){
      for ( int j = 0; j < P; j++ ){
        C(i, j) = 0.0;
        for ( int k = 0; k < N; k++ ){
  ...
  // C = A^{T} * B^{T}
  template<int M, int P, int N, class AMatType, class BMatType, class CMatType>
  void MatTransMatTransMultCore( const AMatType& A, const BMatType& B, const CMatType& C ){
    for ( int i = 0; i < M; i++ ){
      for ( int j = 0; j < P; j++ ){
        C(i, j) = 0.0;
        for ( int k = 0; k < N; k++ ){
