...
*/
template <typename T>
KOKKOS_FUNCTION void Vec3Norm(const Vec<T, 3>& x, T& norm) {
...
*/
template <typename T>
KOKKOS_FUNCTION void Vec3Dot(const Vec<T, 3>& x, const Vec<T, 3>& y, T& a) {
  a = Vec3DotCore<T>(x, y);
}
...
*/
template <typename T>
KOKKOS_FUNCTION void Vec3Normalize(const Vec<T, 3>& x, Vec<T, 3>& v) {
...
template <typename T>
KOKKOS_FUNCTION ADVec3ScaleSymmetricOuterProductExpr<T>
...
template <typename T>
KOKKOS_FUNCTION Vec3ADScaleSymmetricOuterProductExpr<T>
...
template <typename T>
KOKKOS_FUNCTION ADVec3ADScaleSymmetricOuterProductExpr<T>
...
template <int N, typename T>
KOKKOS_FUNCTION A2DVec3VecA2DScalarAxpyExpr<N, T> Vec3Axpy(
...
template <int N, typename T>
KOKKOS_FUNCTION Vec3A2DVecA2DScalarAxpyExpr<N, T> Vec3Axpy(
...
template <int N, typename T>
KOKKOS_FUNCTION A2DVec3A2DVecScalarAxpyExpr<N, T> Vec3Axpy(
...
template <int N, typename T>
KOKKOS_FUNCTION A2DVec3A2DVecA2DScalarAxpyExpr<N, T> Vec3Axpy(
...
template <int N, typename T>
KOKKOS_FUNCTION A2DVec3ScaleSymmetricOuterProductExpr<N, T>
...
template <int N, typename T>
KOKKOS_FUNCTION Vec3A2DScaleSymmetricOuterProductExpr<N, T>
...
template <int N, typename T>
KOKKOS_FUNCTION A2DVec3A2DScaleSymmetricOuterProductExpr<N, T>
