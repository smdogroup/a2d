...
TEST_F(MatxMat, AB) {
  Mat2x2MatMult<T, false, false>(A, B, AB);
  expect_mat_eq<2, 2, Mat>(AB, AB_data);
}

TEST_F(MatxMat, ATB) {
  Mat2x2MatMult<T, true, false>(A, B, ATB);
  expect_mat_eq<2, 2, Mat>(ATB, ATB_data);
}

TEST_F(MatxMat, ABT) {
  Mat2x2MatMult<T, false, true>(A, B, ABT);
  expect_mat_eq<2, 2, Mat>(ABT, ABT_data);
}

TEST_F(MatxMat, ATBT) {
  Mat2x2MatMult<T, true, true>(A, B, ATBT);
...
TEST_F(ADMatxADMat, AB) {
  ...
  auto expr = Mat2x2MatMult<Mat, Mat, Mat, false, false>(A_, B_, C_);
...
TEST_F(ADMatxADMat, ATB) {
  ...
  auto expr = Mat2x2MatMult<Mat, Mat, Mat, true, false>(A_, B_, C_);
...
TEST_F(ADMatxADMat, ABT) {
  ...
  auto expr = Mat2x2MatMult<Mat, Mat, Mat, false, true>(A_, B_, C_);
...
TEST_F(ADMatxADMat, ATBT) {
  ...
  auto expr = Mat2x2MatMult<Mat, Mat, Mat, true, true>(A_, B_, C_);
...
TEST_F(A2DMatxA2DMat, AB) {
  ...
  auto expr = Mat2x2MatMult<1, Mat, Mat, Mat, false, false>(A__, B__, C__);
...
TEST_F(A2DMatxA2DMat, ATB) {
  ...
  auto expr = Mat2x2MatMult<1, Mat, Mat, Mat, true, false>(A__, B__, C__);
...
TEST_F(A2DMatxA2DMat, ABT) {
  ...
  auto expr = Mat2x2MatMult<1, Mat, Mat, Mat, false, true>(A__, B__, C__);
...
TEST_F(A2DMatxA2DMat, ATBT) {
  ...
  auto expr = Mat2x2MatMult<1, Mat, Mat, Mat, true, true>(A__, B__, C__);
...
TEST_F(ADMatxMat, AB) {
  ...
  auto expr = Mat2x2MatMult<T, Mat, Mat, false, false>(A_, B, C_);
...
TEST_F(ADMatxMat, ATB) {
  ...
  auto expr = Mat2x2MatMult<T, Mat, Mat, true, false>(A_, B, C_);
...
TEST_F(ADMatxMat, ABT) {
  ...
  auto expr = Mat2x2MatMult<T, Mat, Mat, false, true>(A_, B, C_);
...
TEST_F(ADMatxMat, ATBT) {
  ...
  auto expr = Mat2x2MatMult<T, Mat, Mat, true, true>(A_, B, C_);
...
TEST_F(MatxADMat, AB) {
  ...
  auto expr = Mat2x2MatMult<T, Mat, Mat, false, false>(A, B_, C_);
...
TEST_F(MatxADMat, ATB) {
  ...
  auto expr = Mat2x2MatMult<T, Mat, Mat, true, false>(A, B_, C_);
...
TEST_F(MatxADMat, ABT) {
  ...
  auto expr = Mat2x2MatMult<T, Mat, Mat, false, true>(A, B_, C_);
...
TEST_F(MatxADMat, ATBT) {
  ...
  auto expr = Mat2x2MatMult<T, Mat, Mat, true, true>(A, B_, C_);
...
TEST_F(A2DMatxMat, AB) {
  ...
  auto expr = Mat2x2MatMult<1, T, Mat, Mat, false, false>(A__, B, C__);
...
TEST_F(A2DMatxMat, ATB) {
  ...
  auto expr = Mat2x2MatMult<1, T, Mat, Mat, true, false>(A__, B, C__);
...
TEST_F(A2DMatxMat, ABT) {
  ...
  auto expr = Mat2x2MatMult<1, T, Mat, Mat, false, true>(A__, B, C__);
...
TEST_F(A2DMatxMat, ATBT) {
  ...
  auto expr = Mat2x2MatMult<1, T, Mat, Mat, true, true>(A__, B, C__);
...
TEST_F(MatxA2DMat, AB) {
  ...
  auto expr = Mat2x2MatMult<1, T, Mat, Mat, false, false>(A, B__, C__);
...
TEST_F(MatxA2DMat, ATB) {
  ...
  auto expr = Mat2x2MatMult<1, T, Mat, Mat, true, false>(A, B__, C__);
...
TEST_F(MatxA2DMat, ABT) {
  ...
  auto expr = Mat2x2MatMult<1, T, Mat, Mat, false, true>(A, B__, C__);
...
TEST_F(MatxA2DMat, ATBT) {
  ...
  auto expr = Mat2x2MatMult<1, T, Mat, Mat, true, true>(A, B__, C__);
...
TEST_F(InvA, AD) {
  ...
  // Check expression result
  auto expr = Mat2x2Inverse(A_, invA_);
  expect_mat_eq<2, 2, Mat>(invA, invA_data, 1e-14);
...
TEST_F(InvA, A2D) {
  ...
  auto expr = Mat2x2Inverse(A__, C__);
...
TEST_F(SymmMultTrace, A) {
  ...
  // Compute
  Symm2x2SymmMultTrace(S, E, trace);
...
TEST_F(SymmMultTrace, AD) {
  ...
  auto expr = Symm2x2SymmMultTrace(S_, E_, trace_);
...
TEST_F(SymmMultTrace, A2D) {
  ...
  auto expr = Symm2x2SymmMultTrace(S__, E__, trace__);
...
TEST_F(SymmIsoConstitutive, A) {
  ...
  // Compute
  Symm2x2IsotropicConstitutive(mu, lam, E, S);
...
TEST_F(SymmIsoConstitutive, AD) {
  ...
  auto expr = Symm2x2IsotropicConstitutive(mu, lam, E_, S_);
...
TEST_F(SymmIsoConstitutive, A2D) {
  ...
  auto expr = Symm2x2IsotropicConstitutive(mu, lam, E__, S__);
...
TEST_F(SymmIsoEnergy, A) {
  ...
  // Compute
  Symm2x2IsotropicEnergy(mu, lam, E, w);
...
TEST_F(SymmIsoEnergy, AD_E_only) {
  ...
  // Compute
  auto expr = Symm2x2IsotropicEnergy(mu, lam, E_, w_);
...
TEST_F(SymmIsoEnergy, AD_E_mu_lam) {
  ...
  // Compute
  auto expr = Symm2x2IsotropicEnergy(mu_, lam_, E_, w_);
...
TEST_F(SymmIsoEnergy, A2D_E_only) {
  ...
  // Compute
  auto expr = Symm2x2IsotropicEnergy(mu, lam, E__, w__);
...
TEST_F(SymmIsoEnergy, A2D_E_mu_lam) {
  ...
  // Compute
  auto expr = Symm2x2IsotropicEnergy(mu__, lam__, E__, w__);
...
TEST_F(GreenStrain, AD) {
  ...
  // Compute
  auto expr = Mat2x2GreenStrain(Ux_, E_);
...
TEST_F(GreenStrain, A2D) {
  ...
  // Compute
  auto expr = Mat2x2GreenStrain(Ux__, E__);
...
TEST_F(LinearGreenStrain, AD) {
  ...
  // Compute
  auto expr = Mat2x2LinearGreenStrain(Ux_, E_);
...
TEST_F(LinearGreenStrain, A2D) {
  ...
  // Compute
  auto expr = Mat2x2LinearGreenStrain(Ux__, E__);
