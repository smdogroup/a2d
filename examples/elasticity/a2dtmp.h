...
class A2DMat3x3MatMultExpr
    : public A2DExpression<
          A2DMat3x3MatMultExpr<AMatType, BMatType, CMatType, AT, BT> > {
 public:
  A2DMat3x3MatMultExpr(A2DMat<AMatType>& AObj, A2DMat<BMatType>& BObj,
...
template <class AMatType, class BMatType, class CMatType, bool AT = false,
          bool BT = false>
inline A2DMat3x3MatMultExpr<AMatType, BMatType, CMatType, AT, BT> Mat3x3MatMult(
    A2DMat<AMatType>& AObj, A2DMat<BMatType>& BObj, A2DMat<CMatType>& CObj) {
  return A2DMat3x3MatMultExpr<AMatType, BMatType, CMatType, AT, BT>(AObj, BObj,
                                                                    CObj);
}
...
class A2DpMat3x3MatMultExpr
    : public A2DExpression<
          A2DpMat3x3MatMultExpr<ScalarType, BMatType, CMatType, AT, BT> > {
 public:
  typedef Mat<ScalarType, 3, 3> Mat3x3;

  A2DpMat3x3MatMultExpr(Mat3x3& A, A2DMat<BMatType>& BObj,
                        A2DMat<CMatType>& CObj)
      : A(A), BObj(BObj), CObj(CObj) {
    const BMatType& B = BObj.value();
    CMatType& C = CObj.value();
...
Mat3x3MatMult(Mat<ScalarType, 3, 3>& A, A2DMat<BMatType>& BObj,
              A2DMat<CMatType>& CObj) {
  return A2DpMat3x3MatMultExpr<ScalarType, BMatType, CMatType, AT, BT>(A, BObj,
                                                                       CObj);
}
...
class A2DMat3x3pMatMultExpr
    : public ADExpression<
          A2DMat3x3pMatMultExpr<ScalarType, AMatType, CMatType, AT, BT> > {
 public:
  typedef Mat<ScalarType, 3, 3> Mat3x3;

  A2DMat3x3pMatMultExpr(A2DMat<AMatType>& AObj, Mat3x3& B,
                        A2DMat<CMatType>& CObj)
      : AObj(AObj), B(B), CObj(CObj) {
    const AMatType& A = AObj.value();
    CMatType& C = CObj.value();
...
Mat3x3MatMult(A2DMat<AMatType>& AObj, Mat<ScalarType, 3, 3>& B,
              A2DMat<CMatType>& CObj) {
  return A2DMat3x3pMatMultExpr<ScalarType, AMatType, CMatType, AT, BT>(AObj, B,
                                                                       CObj);
}
...
class A2DMat3x3DetExpr
    : public ADExpression<A2DMat3x3DetExpr<MatType, ScalarType> > {
 public:
  A2DMat3x3DetExpr(A2DMat<MatType>& AObj, A2DScalar<ScalarType>& detObj)
      : AObj(AObj), detObj(detObj) {
    const MatType& A = AObj.value();
...
template <class MatType, typename ScalarType>
inline A2DMat3x3DetExpr<MatType, ScalarType> Mat3x3Det(
    A2DMat<MatType>& A, A2DScalar<ScalarType>& det) {
...
class A2DMat3x3InverseExpr
    : public A2DExpression<A2DMat3x3InverseExpr<MatType, InvMatType> > {
 public:
  typedef typename MatType::type ScalarType;

  A2DMat3x3InverseExpr(A2DMat<MatType>& AObj, A2DMat<InvMatType>& AinvObj)
      : AObj(AObj), AinvObj(AinvObj) {
    const MatType& A = AObj.value();
    InvMatType& Ainv = AinvObj.value();
...
template <class MatType, class InvMatType>
inline A2DMat3x3InverseExpr<MatType, InvMatType> Mat3x3Inverse(
    A2DMat<MatType>& AObj, A2DMat<InvMatType>& AinvObj) {
...
class A2DSymm3x3SymmMultTraceExpr
    : public A2DExpression<
          A2DSymm3x3SymmMultTraceExpr<SMatType, EMatType, ScalarType> > {
 public:
  A2DSymm3x3SymmMultTraceExpr(A2DMat<SMatType>& SObj, A2DMat<EMatType>& EObj,
...
Symm3x3SymmMultTrace(A2DMat<SMatType>& S, A2DMat<EMatType>& E,
                     A2DScalar<ScalarType>& trace) {
  return A2DSymm3x3SymmMultTraceExpr<SMatType, EMatType, ScalarType>(S, E,
                                                                     trace);
}
...
Symm3x3IsotropicConstitutive(const ScalarType& mu, const ScalarType& lambda,
  ...
  return A2DSymm3x3IsotropicConstitutiveExpr<ScalarType, EMatType, SMatType>(
      mu, lambda, E, S);
}
...
class A2DMat3x3GreenStrainExpr
    : public A2DExpression<A2DMat3x3GreenStrainExpr<UxMatType, EMatType> > {
 public:
  A2DMat3x3GreenStrainExpr(A2DMat<UxMatType>& UxObj, A2DMat<EMatType>& EObj)
      : UxObj(UxObj), EObj(EObj) {
    const UxMatType& Ux = UxObj.value();
    EMatType& E = EObj.value();
    E(0, 0) = Ux(0, 0) + 0.5 * (Ux(0, 0) * Ux(0, 0) + Ux(1, 0) * Ux(1, 0) +
...
template <class UxMatType, class EMatType>
inline A2DMat3x3GreenStrainExpr<UxMatType, EMatType> Mat3x3GreenStrain(
    A2DMat<UxMatType>& Ux, A2DMat<EMatType>& E) {
...
class A2DMat3x3LinearGreenStrainExpr
    : public A2DExpression<
          A2DMat3x3LinearGreenStrainExpr<UxMatType, EMatType> > {
 public:
  A2DMat3x3LinearGreenStrainExpr(A2DMat<UxMatType>& UxObj,
                                 A2DMat<EMatType>& EObj)
      : UxObj(UxObj), EObj(EObj) {
    const UxMatType& Ux = UxObj.value();
    EMatType& E = EObj.value();
